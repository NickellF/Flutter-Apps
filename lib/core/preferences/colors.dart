...
class AppColors {
  ...
  static const tako = MaterialColor(0xFFFF722C, {
    50: Color(0xFFFFEBEE), // Lightest shade
    100: Color(0xFFFFC1B6),
    200: Color(0xFFFFA07A),
    300: Color(0xFFFF7D4D),
    400: Color(0xFFFF5A2D),
    500: Color(0xFFFF722C), // Main color
    600: Color(0xFFEA5E24),
    700: Color(0xFFD05420),
    800: Color(0xFFB74A1C),
    900: Color(0xFF9B3D16), // Darkest shade
  });
